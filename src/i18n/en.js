export default {
    ...
    'features.advanced_search.description': 'Parallel operation of many servers ensures high speed of processing requests.',
    'features.advanced_search.title': 'ADVANCED SEARCH',
    'features.decentralization.description': 'The absence of a single center control and failure, a completely self–organized network.',
    ...
    // Header
    'header.slogan': 'A public, distributed and decentralized database\nwith one common thread: trust.',
    ...
    'how_it_works.upload.description': 'Anyone can post content. It is distributed across different servers.',
    ...
    'roadmap.2017_q3.description': 'Pre Token generation event marketing campaign. Yellow paper published. Prototype launch and testing. TGE announced.',
    ...
    'roadmap.2018_q4.description': 'Full decentralization launch. OasisDDB Beta launch. OasisDDB marketing campaign.',
    ...
    'team.mukhanov.description': 'Sergey Mukhanov is a skilled professional with over 10-year experience in product management and development of innovative payment solutions from scratch to 40-million audience. He has extensive work experience with banks, telecommunication companies and worldwide payment systems.',
    ...
    'why_need.dapps.description': 'Ties.DB servers are completely independent, scattered across the planet and accept payment in the crypto currency (TIE-token), which gives dapps-y very flexible options for working with the network Ties.DB.',
    'why_need.dapps.link': 'BE 100% DECENTRALIZED',
    'why_need.dapps.preface': 'Centralized storage solutions are vulnerable. Decentralized solutions used Today, they do not allow a quick search and modification of data.',
    'why_need.dapps.title': 'DAPPS',
  
    'why_need.blockchain.description': 'We take from a concrete block system data encryption to generate keys in the signature and suggest that the creation of decentralized applications for This block, announcing that the data will be stored in Ties.DB.',
    'why_need.blockchain.link': 'BE 100% COMPETITIVE',
    'why_need.blockchain.preface': 'Today there is no effective storage solution data that entails the difficulty of attracting and hold dApps.',
    'why_need.blockchain.title': 'BLOCKCHAINS',
  
    'why_need.international.description': 'Large projects can store Ties.DB file indexes, and in the future, store in Ties.DB and the files themselves. Any large project can make a fork of Ties.DB network to store data in a separate network.',
    'why_need.international.link': 'BE 100% BOUNDLESS',
    'why_need.international.preface': 'It is difficult to build self-service today cross-border infrastructure.',
